...
public class CFloatMinimumValueValidatorMessage implements CValidMessage {
String fieldName;
float minValue;


public CFloatMinimumValueValidatorMessage() {
	super();
}
public CFloatMinimumValueValidatorMessage(String fieldName, float minValue) {
	super();
...
public String toString() {
	return "CFloatMinimumValueValidatorMessage [fieldName=" + fieldName
			+ ", minValue=" + minValue + "]";
}
@Override

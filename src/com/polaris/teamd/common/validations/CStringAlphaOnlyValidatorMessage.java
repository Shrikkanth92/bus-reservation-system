...
public class CStringAlphaOnlyValidatorMessage implements CValidMessage{
	String fieldName;
	
	public CStringAlphaOnlyValidatorMessage() {
		super();
	}

	public CStringAlphaOnlyValidatorMessage(String fieldName) {
		super();
	...
	public String toString() {
		return "CStringAlphaOnlyValidatorMessage [fieldName=" + fieldName + "]";
	}

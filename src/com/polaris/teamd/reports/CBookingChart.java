...
public class CBookingChart extends CReport {
	String fileName;
	CTripSeat tripSeat;
	...
	void generateReport(Object... param) {
		try {
			...
			writer.write(HTMLUtil.endCell());
			writer.write(HTMLUtil.createCell("GENDER"));
			writer.write(HTMLUtil.endCell());
			writer.write(HTMLUtil.createCell("IDPROOF TYPE"));
			writer.write(HTMLUtil.endCell());
			writer.write(HTMLUtil.createCell("ID PROOF NUMBER"));
			writer.write(HTMLUtil.endCell());
			writer.write(HTMLUtil.endRow());

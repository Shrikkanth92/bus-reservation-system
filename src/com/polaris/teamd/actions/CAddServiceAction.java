...
public class CAddServiceAction extends AbstractAction {

	@Override
	public void actionPerformed(ActionEvent e) {
		JPanel target = ApplicationCache.get("CONTENTSCREEN");
		JPanel mypanel = new CAddService();
		target.removeAll();
		target.add(mypanel);
		...
		welcomeForm.cInit("Welcome to Add Service Wizard");
		finishForm.cInit("Congratulations!");
		CLabel label= new CLabel("This wizard will help you to add new service for an Operator.");
		CLabel label2= new CLabel("1.Add Basic Information regarding the new Service.");
		CLabel label3= new CLabel("2.Select the service days and boarding points.");
		CLabel label4= new CLabel("3.Add Intermediate Cities if any.");
		CLabel label5= new CLabel("You have added a bus service successfully");
		...
		CForm cForm1 = new CUIFactory()
				.createForm("resources/forms/caddserviceform/caddserviceform00.properties");
		...
		CForm cForm2 = new CUIFactory().createForm("resources/forms/caddserviceform/caddserviceform01.properties");
		...
		CForm cForm3 = new CUIFactory()
				.createForm("resources/forms/caddserviceform/caddserviceform02.properties");
